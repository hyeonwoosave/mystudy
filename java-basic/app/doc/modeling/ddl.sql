...
CREATE TABLE lms_application (
  ...
  lectures_no    INTEGER  NOT NULL COMMENT '과정번호', -- 과정번호
...
CREATE TABLE lms_lectures (
  ...
  day_hr      DATETIME     NOT NULL COMMENT '일교육시간', -- 일교육시간
  total_hr    DATETIME     NOT NULL COMMENT '총교육시간', -- 총교육시간
...
ALTER TABLE lms_lectures
  MODIFY COLUMN lectures_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '과정번호';
